...
public class Dealer {
    ...
    public final void createCards() {
        String[] weapons = {"Rope", "Lead Pipe", "Knife", "Wrench", "Candlestick",
                "Pistol"};
        String[] people = {"Colonel Mustard", "Miss Scarlet", "Professor Plum",
                "Mr. Green", "Mrs. White",
                "Mrs. Peacock"};
        String[] rooms = {"Ballroom", "Kitchen", "Dining Room", "Lounge", "Hall", "Study",
    ...
    public final void printCards() {
        for (int i = 0; i < cards.size(); i++) {
            System.out.println(
                    i + ". " + cards.get(i).getName() + " Type: " + cards.get(i)
                            .getType());
        }
    }
    ...
    public final void printKillerCaseFile() {
        for (int i = 0; i < killerCaseFile.size(); i++) {
            System.out
                    .println(i + ". " + killerCaseFile.get(i).getName() + " Type: "
